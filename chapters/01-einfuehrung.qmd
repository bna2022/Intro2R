...
Skriptdateien für R-Programme besitzen üblicherweise die Dateiendung `.R`, zum Beispiel `Beispiel.R`.
...
Bequemer ist dies allerdings mit speziellen Entwicklungsumgebungen, den sogenannten IDEs. 
