...
## 12. Balkendiagramme mit bereits aggregierten Daten
...
## 17. Typische Fehler bei ggplot2
...
Die Metadaten der Proben stehen in:
...
Eine Gruppentabelle lässt sich dann so erzeugen:
...
Diese Tabelle entspricht der Idee der manuell angelegten Tabelle `groups` aus diesem Kapitel.
